...
class NavBar extends React.Component{
    ...
    render(){
      ...
      return(
        ...
        //   Home
        //   </a>
//We never use anchor tag inside react coz it reloads the page
...
About
</Link><Link to='/projects' className={`menu-item ${projectsClass}`}>
Projects
</Link><Link to='/skills' className={`menu-item ${skillsClass}`}>
Skills
</Link><Link to='/contact' className={`menu-item ${contactClass}`}>
Contact
</Link>
      </Menu>
